...
function sendMessage(event) {
    ...
    conversation.message({
        ...
        workspace_id: "d0442102-aa14-464d-9132-e08f9e08ebf9",
        context: context,
    }, (err, response) => {
        if (err) {
            console.log(err);
            ...
            request({
                ...
                qs: {
                    access_token: "EAAEFcnrSHJ8BAF3KCUVkPA8gdmkbT4p2EUpCKD0LlivjeyojiqJykCJROCsaSDIlp6BqypSh1R8tA6yAvXG28nK49A0j3AyIdE7D5ICX4hxJrfoGAS0Iq1EfhDnJO9MLytp2rBmjCXq7x8pbg869g9dRMN9CzVZBqHFZBoAwZDZD"
